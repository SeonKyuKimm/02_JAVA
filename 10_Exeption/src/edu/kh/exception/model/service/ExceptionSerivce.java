...
public class ExceptionSerivce {
	...
	public void ex1() {
		...
		try {
			...
			// Try에서 던져진 예외를 catch문의 매개변수 e로 잡은것.
	...
	public void ex2() {
		...
		try {
			...
			//    다형성 업캐스팅에 의해 모두 잡아서 처리가 가능하다!! **
			
			System.out.println("뭔지 모르겠으나 예외가 발생해서 처리했음..");
			e.printStackTrace(); 
			// 예외가 발생한 발자국? 발생한 예외에 대한 메서드와 위치에 대한 모든 내용 출력
			// 예외 발생 지점 추적
		}
	...
	public void ex3() {
		...
		try {
			...
			sc.close(); 
			// 스캐너 통로 닫기 : 메모리 누수 방지. finally 구문에 작성.
		}
	...
	public void ex4() {
		...
		try {
			...
			System.out.println("메서드 c에서부터 발생한 예외를 ex4에서 잡아 처리함");
