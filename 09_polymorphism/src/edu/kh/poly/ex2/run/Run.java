...
import edu.kh.poly.ex2.model.service.KSGCalculator;
...
public class Run {
	 ...
	 * 		((ex . KSGCalculator 계산기 .
	 * 		 Run에 작성된 합, 차, 곱, 몫을 출력하는 코드의 수정 없이
	 * 		 객체 생성 코드 한 줄만 수정하여 다르게 작성된 기능을 수항핼 수 있다.))
	 * 
	 * 2) 자식 클래스에 공통된 메서드 구현을 강제하기 때문에 
	 * 	  모든 자식 클래스가 동일한 형태를 띄게 된다.
	 *	-> 이를 이용하여 공동 작업( 팀 프로젝트)에 필요한 개발환경을 조성할 수 있다.  
	 */
