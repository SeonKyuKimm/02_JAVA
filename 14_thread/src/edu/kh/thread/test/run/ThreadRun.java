...
public class ThreadRun {
	// Thread(스레드) : 컴퓨터 프로그램 실행의 기본 단위중 하나
	...
	// 2 . 비동기적인 작업 수행이 가능하다
	// ex) 네트워크 요청이나 파일 입출력과 같은 I/O 작업은 대기시간이 발생할 수 있으므로
	//  스레드를 사용하여 메인 작업과 병렬로 처리할 수 있다.

	
	// 병렬 처리 : 하나의 작업을 여러 부분으로 나누어서 동시에 처리하는것
