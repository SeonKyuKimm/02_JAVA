...
public class Person {
	...
	// ex) 123    		   ->  qwerty
	//		asdfbewsfdaqef ->  asdfgh 
	// 암호화에 많이 사용
	
	// hashCode() : 객체별 식별 코드 ( 객체를 구분하는 '정수 값') 를 반환
	// ex ) 주민등록번호 , 학번 , 은행 번호표... 등
	
	/*
	@Override // 컴파일러에게 오버라이딩 잘 하고 있는지 검사
	public int hashCode() {
	...
	*/
	// Hashcode alt shift s에 항목이 있음 ( Generate hashCode() and equals() ) 
