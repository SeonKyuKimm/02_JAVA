...
public class InheritanceService {
	...
	public void ex1() {
		...
		// Person을 상속받은 Student가 Person,필드,메서드를
		// 정말 사용할 수 있는가?
	
		// Student 객체 생성
		Student std = new Student();
		
		// Student만의 고유한 필드(여기선 학년,반)
	...
	public void ex2() {
		...
		System.out.println("< 국적 : " + std.getNationality() + " >" );
	...
	public void ex4() {
		...
		// print 구문 소행 시 참조변수명을 작성하면
		// 자동으로 toString()메소드를 호출해서 출력해준다
		
		System.out.println("------------------------------");
		
		Student std = new Student("이백정", 18, "미국", 2, 6);
